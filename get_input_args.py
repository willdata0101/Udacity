...
# Predict Args
parser.add_argument('--checkpoint', action='store', type=str, dest='checkpoint', help='checkpoint filename')
parser.add_argument('--topk', action='store', type=str, default='20', help='return top K most likely classes')
parser.add_argument('--cat_to_name', action='store', type=str, default='cat_to_name.json', help='use mapping of categories to real names')
